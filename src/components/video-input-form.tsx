  ...
  return (
    <>
      ...
      <form onSubmit={handleUploadVideo} className='space-y-6'>
        <label
          htmlFor='video'
          className='relative border w-full flex flex-col gap-2 items-center justify-center text-muted-foreground hover:bg-violet-700 hover:text-white rounded-md aspect-video cursor-pointer border-dashed text-sm'
        >
          {previewURL ? (
            <>
              <video
